...
1. Setting up React-Router and routes for the whole app.
2. refactoring this.props into sth nicer inside the components.
3. Setting up specific routes such as Authentication Route, Feature Flag Route, etc.
